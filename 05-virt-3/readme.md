...
Docker [подойдёт](https://grafana.com/blog/2019/05/07/ask-us-anything-should-i-run-prometheus-in-a-container/ "Ask Us Anything: Should I Run Prometheus in a Container?") хорошо, т.к. это позволит быстро развернуть приложение со всеми необходимыми библиотеками.

3. **Мобильное приложение c версиями для Android и iOS**

Docker не подходит для мобильных приложений и в целом для приложений с графическим интерфейсом.
...
Docker в связке с Kubernetes будет хорошим решением для управления такой инфраструктурой.

6. **Мониторинг-стек на базе Prometheus и Grafana**

Docker подойдёт для этой задачи хорошо. Разворвачивать node_exporter с Docker скорей всего не стоит, т.к. ему требуется прямой доступ к метрикам ядра, но Prometheus и Grafana можно использовать в Docker.
