...
2. Основополагающий принцип IaaC: **Идемпотентность** - возможность описать желаемое состояние того, что конфигурируется, с определённой гарантией что оно будет достигнуто.
